...
The DNA project is an example of assembling DNA strands with their matching pair.
Its is a practice in using custom DRUPAL 7 modules, php, REGEX, and AJAX
